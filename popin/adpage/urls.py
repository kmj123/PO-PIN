...
urlpatterns = [
    ...
    path('user/delete/<str:delete_user_id>/', views.delete_user, name='delete_user'),  # 계정 삭제
    path('user/block/<str:block_user_id>/', views.block_user, name='block_user'),      # 계정 정지 / 정지 해제
