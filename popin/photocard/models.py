...
class Photocard(models.Model):
    ...
    buyer = models.ForeignKey(TempUser, on_delete=models.SET_NULL, null=True, related_name='buy')
    ...
    tag = models.CharField(max_length=20, null=True, blank=False)  # choices 생략됨
    ...
    buy_state = models.CharField(max_length=20, choices=TRADE_STATE_CHOICES, null=True)
    ...
    def __str__(self):
        return f'{self.title} ({self.group}/{self.member})'
